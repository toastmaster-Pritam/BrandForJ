...
import { LockKeyholeIcon, Mail, Loader2 } from "lucide-react";
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      if (result.status === "complete") {
        ...
        console.error("Sign-in flow not complete:", result);
      }
    } catch (error: any) {
      console.error("Error signing in:", error.errors || error.message);
      ...
      <div className="z-50 flex items-center justify-center lg:justify-start lg:pl-20 min-h-screen px-5 animate-slide-left">
        <div className="w-full max-w-md p-8 bg-transparent">
          ...
          <p className="text-sm text-gray-500 text-center lg:text-left mt-2">
            Sign in to Create, Customize & Elevate.
          </p>
          ...
          <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input
                  ...
                  type="email"
                  placeholder="Email"
                  className="mt-1 pl-10 bg-white border border-gray-300 shadow-lg focus:border-indigo-500 focus:ring-indigo-500 "
            ...
            <Button
              type="submit"
              className="w-full bg-green-500 hover:bg-green-600 text-white flex justify-center items-center"
